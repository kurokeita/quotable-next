...
export default async function Home({ searchParams }: { searchParams: Promise<HomeQueryParams> }) {
	await healthCheck()
		...
		<div className='grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]'>
			{/* <div className='fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-lg shadow-md'>
				<div className='max-w-2xl mx-auto p-4'>
					<form className='w-full max-w-xl mx-auto flex justify-center gap-4' action={() => {}}>
